...
//using defalut parameters with classes  
class WithDefaultParams {
    constructor(num1 = 1, num2 = 2, num3 = 3, string1 = "Result of the class with default parameters is:", bool1 = true) {
        this.num1 = num1;
        this.num2 = num2;
        this.num3 = num3;
...
function withDefaultParameter(number = 5) {
    console.log("The result of the default parameter function is: ", number * number);
}
